...
use crate::registries::http::storage::backends::local::LocalStorageBackend;
use crate::registries::http::storage::backends::s3::S3StorageBackend;
...
impl StorageBackend {
    pub async fn from_local_args(
        args: RegistrySubcommandRunSubcommandArgsStorageLocal,
    ) -> anyhow::Result<Self> {
    ...
    pub async fn from_s3_args(
        args: RegistrySubcommandRunSubcommandArgsStorageS3,
    ) -> anyhow::Result<Self> {
